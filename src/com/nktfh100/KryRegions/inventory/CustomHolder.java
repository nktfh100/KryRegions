...
public class CustomHolder implements InventoryHolder {
	...
	protected ClickAction globalClickAction = null;
	...
	public void setGlobalClickAction(ClickAction action) {
		this.globalClickAction = action;
	}

	public void click(InventoryClickEvent ev) {
		if (this.globalClickAction != null) {
			this.globalClickAction.execute((Player) ev.getWhoClicked(), ev);
		}
	}
